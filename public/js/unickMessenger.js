				...
				success:function(data){
					...
					for(var index in data.contacts){
						...
						$this.find('.thread-list').append(
							...
							+'		<div class="description">'+(data.contacts[index].latest_message[0] ? (data.contacts[index].latest_message[0].user_id == settings.auth_id ? '<span style="color:#757575;">You</span> : ' : '')+data.contacts[index].latest_message[0].message : '')+ '</div>'
							+'	</div>'
							+'</div>'
				...
				success:function(data){
					...
					for(var index in data.users){
						$this.find('.thread-list').append(
							...
							+'		<div class="description">'+(data.users[index].latest_message[0] ? (data.users[index].latest_message[0].user_id == settings.auth_id ? '<span style="color:#757575;">You</span> : ' : '')+data.users[index].latest_message[0].message : '')+ '</div>'
							+'	</div>'
							+'</div>'
							+'<div class="col pdd-5 hide-728">'
							+'</div>'
