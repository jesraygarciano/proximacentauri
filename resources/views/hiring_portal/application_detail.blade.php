            ...
            <div class="col-md-3">
              ...
              <div class="box box-primary">
                <div class="box-body box-profile">
                  ...
                  <h3 class="profile-username text-center">{{ $resume->f_name }} {{ $resume->m_name }} {{ $resume->l_name }}</h3>
            ...
            <div class="col-md-9">
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#activity" data-toggle="tab">Objective</a></li>
                  <li><a href="#timeline" data-toggle="tab">Expected Salary</a></li>
                  <li><a href="#settings" data-toggle="tab">Available Time</a></li>
                </ul>
